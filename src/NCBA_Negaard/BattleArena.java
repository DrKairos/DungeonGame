...
class itemwin {
    ...
    Image currentImage;
    Shape hitbox;
    Image antidote = new Image("res/DogeBoss.png");
...
//        Eli.currentImage.draw(Eli.x, Eli.y);
//        Ile.currentImage.draw(Ile.x, Ile.y);
//        Kairos.currentImage.draw(Kairos.x, Kairos.y);
